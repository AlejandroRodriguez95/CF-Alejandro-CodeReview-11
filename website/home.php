...
<?php 
    ...
    <div class="container">
            ...
            if($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    if ((isset($_SESSION['admin'])) || (isset($_SESSION['superadmin']))){
                        echo"
                        <div class='card-body'>
                            <a href='update.php?id=" .$row['animal_id']."'><button class='btn btn-primary' type='button'>Edit</button></a>
                            <a href='actions/a_delete.php?id=" .$row['animal_id']."'><button class='btn btn-primary' type='button'>Delete</button></a>
                        </div>";}
                    echo "
                    </div>";
            }} else  {
        ...
        if ((isset($_SESSION['admin'])) || (isset($_SESSION['superadmin']))){
        echo '<div class="row">
            <a class="col-2 mx-auto pb-3" href="create.php"><button type="button" class="btn btn-danger">Add Animal</button></a>
        </div>';
        }
        ?>
